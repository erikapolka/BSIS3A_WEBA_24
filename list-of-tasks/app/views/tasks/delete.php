...
<div class="col col-12 mt-5">
    <div class="h1 text-center">D e l e t e T a s k </div>
</div>
    ...
    <div class="d-flex justify-content-center">
        <form method="post" class="">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="taskName" name="task_name" value="<?= $rows->task_name ?>" disabled>
            </div>
            <div class="mb-3">
                <label for="taskDescription" class="form-label">Description</label>
                <textarea class="form-control" id="taskDescription" name="task_description" maxlength="50" disabled><?= $rows->task_description ?></textarea>
            </div>
            <div class="mb-3">
                <label for="taskStatus" class="form-label">Status</label>
                <select class="form-select" id="taskStatus" name="task_status" disabled>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="taskDue" name="task_due" value="<?= $rows->task_due ?>" disabled>
            </div>
