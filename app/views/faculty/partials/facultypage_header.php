...
<body style=" font-family: Poppins;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="<?= ROOT ?>/facultypage/home">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="m-5">
                        ...
                        <p>Name: <?= $_SESSION['USER']->faculty_fname . ' ' . $_SESSION['USER']->faculty_mname . ' ' . $_SESSION['USER']->faculty_lname ?></p>
                        <p>Email: <?= $_SESSION['USER']->faculty_email ?></p>
...
<div class="modal fade" id="changePassModal" tabindex="-1" role="dialog" aria-labelledby="changePassModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= ROOT ?>/facultypage/changepass" method="post">
                    <div class="modal-body">
